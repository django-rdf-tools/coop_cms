...
class BaseArticle(TimeStampedModel):
    ...
    in_newsletter = models.BooleanField(_(u'In newsletter'), default=True, help_text=_('make this article available for newsletters.'))
    is_homepage = models.BooleanField(_(u'Is homepage'), default=False, help_text=_('Make this article the website homepage (only one homepage per site)'))
